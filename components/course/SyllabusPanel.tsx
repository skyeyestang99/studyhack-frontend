          ...
          <div
            className={
              ...
              daysUntil(highlightedExam.dueAt) <= 14
                ? "rounded-2xl border bg-primary p-4 text-white shadow-sm"
                : "rounded-2xl border border-brand/40 bg-brand/10 p-4 text-brand-foreground shadow-sm"
            }
          >
            ...
            <p
              className={
                ...
                daysUntil(highlightedExam.dueAt) <= 14
                  ...
                  : "mt-1 text-sm text-brand-foreground"
              }
            >
            ...
            {daysUntil(highlightedExam.dueAt) >= 0 && (
              <Button className="mt-3 bg-card text-foreground hover:bg-card/90" size="sm">
